...
Plugin Name: daalabifooter_plugin
...
function custom_plugin_setting_page()
{
    ...
    add_menu_page('Custom Plugin', 'DAALABI Footer', 'manage_options', 'custom-plugin-setting-url', 'custom_page_html_form', plugins_url('custom-plugin/img/icon.png'));
...
{ ?>
    <div class="wrap">
        <h2>DAALABI Footer Plugin Setting</h2>
...
function say_hello()
{
  ...
  <div class="footer-left"><p>Contact : daalabireda@gmail.com
  ');

    echo get_option("email");

    echo ('</p></div>
  <div class="footer-center">All rights reserved<p>
  ');
  ...
  <div class="footer-right"><a href=');
    ...
    echo ('><img class="icon" src="https://img.icons8.com/ios-filled/344/ffffff/facebook-new.png" alt="facebook" width="30px"></a>
    <a href=');

    echo get_option("whatsapp_url");

    echo ('><img class="icon" src="https://img.icons8.com/ios-filled/344/ffffff/whatsapp.png" alt="whatsapp" width="30px"></a>
  <a href=');

    echo get_option("twitter_url");

    echo ('><img class="icon" src="https://img.icons8.com/ios-filled/344/ffffff/twitter-circled.png" alt="twitter" width="30px"></a>
  <a href=');

    echo get_option("linkedin_url");

    echo ('><img class="icon" src="https://img.icons8.com/ios-filled/344/ffffff/linkedin-circled.png" alt="linkedin" width="30px"></a></div>
  </div>
  ');
